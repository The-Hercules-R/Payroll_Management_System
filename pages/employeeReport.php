    ...
    <nav class="navbar sticky-top navbar-expand-sm">
        <div class="container-fluid">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="../pages/employeeReport.html">Employee Report</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="../pages/salary.html">Salary</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="../pages/salaryReport.html">Salary Report</a>
                </li>
            </ul>
        </div>
